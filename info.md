...
After installing, add it via **Settings → Devices & Services → Add Integration →
Zettlab AINAS**, then sign in with your NAS web credentials (default user
`admin`).

See the [README](https://github.com/xianleewu/zettlab-ainas-iot) for full docs
(English / 简体中文).
